...
<%--
	- 태그에 내부 스타일 시트 방식으로 디자인을 적용하려면 선택자를 사용합니다.
	- class 선택자 : .클래스 이름
	- id 선택자 : #아이디 이름
	- 태그 선택자 : 태그 이름
 --%>
...
<body>
 <%--
 	* CSS(Cascade Style Sheet)
 	...
 	3. 외부 스타일 시트 = 외부에 .css.인 파일을 따로 만들어서 디자인 소스만 모두 지정한 뒤 HTML에서 링크를 통해 로딩시킴.
 
  --%>

	<%-- div태그에 인라인 스타일 시트 적용 --%>
	<div align="center" style="border:2px dotted blue; width:80%; padding:15px"">
